...
class supportVC: baseViewControllerM {
    ...
    func setUpViewsSupportVc(){
        ...
        whatsapp.topAnchor.constraint(equalTo: darkGrayCard.topAnchor, constant: 20).isActive = true
        ...
        onlineSupport.topAnchor.constraint(equalTo: whatsapp.bottomAnchor, constant: 20).isActive = true
        ...
        // icon
        let onlineIcon = UIImageView(image: #imageLiteral(resourceName: "ic_transfer"))
        ...
        twitter.topAnchor.constraint(equalTo: onlineSupport.bottomAnchor, constant: 20).isActive = true
        ...
        youtube.topAnchor.constraint(equalTo: facebook.bottomAnchor, constant: 20).isActive = true
        ...
        sendMail.topAnchor.constraint(equalTo: youtube.bottomAnchor, constant: 20).isActive = true
        ...
        businessSoln.topAnchor.constraint(equalTo: sendMail.bottomAnchor, constant: 20).isActive = true
        ...
        lblbusinessSoln.leadingAnchor.constraint(equalTo: businessSolnIcon.trailingAnchor, constant: 5).isActive = true
        ...
        talkToAgent.topAnchor.constraint(equalTo: businessSoln.topAnchor, constant: 20).isActive = true
        ...
        faultRep.topAnchor.constraint(equalTo: talkToAgent.bottomAnchor, constant: 20).isActive = true
