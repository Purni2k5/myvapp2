                        ...
                        do {
                            ...
                            if let parseJSON = myJSON {
                                ...
                                if responseCode == 1 || responseCode == 2 {
                                    ...
                                    shareStatusMessage = parseJSON["SHARESTATUSMESSAGE"] as! String?
                                    var shareStatus: Int?
                                    shareStatus = parseJSON["SHARESTATUS"] as! Int?
                                    let responseData = parseJSON["RESPONSEMESSAGE"] as! NSDictionary?
                                    if let rsData = responseData {
                                        let subADSLShare = rsData["C_SUB_ADSL_SHARE"] as! String?
                                        let subADSLShareValidity = rsData["C_SUB_ADSL_SHARE_VALIDITY"] as! String?
                                        let subADSLShareDate = rsData["C_SUB_ADSL_SHARE_DATE"] as! String?
                                    }
